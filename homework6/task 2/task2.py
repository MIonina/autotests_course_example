...
def global_function():
    """
    Функция возвращает локальную переменную, измененную в локальной функции local_function.
    :return: измененная локальная переменная msg.
    """
    msg = 1

    def local_function():
        """
        Функция изменяет значение переменной msg.
        """
        nonlocal msg
        msg = 2
    local_function()
