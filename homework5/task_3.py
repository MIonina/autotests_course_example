...
def everything_for_your_cat(cats_data):
    """
    Функция оптимизирует хранение данных о кошках и их владельцах, записанных списком кортежей.
    [(Кличка котика, Возраст котика, Имя покупателя, Фамилия покупателя)]
    --->
    "Имя_покупателя Фамилия_покупателя: Кличка_котика1, Возраст; ...; Кличка_котикаN, Возраст\n"
    :param cats_data: книга о котах и покупателях, записанная списком кортежей, где каждый кортеж состоит из:
    Кличка котика, Возраст котика, Имя покупателя, Фамилия покупателя.
    :return: строка для каждого владельца с данными о всех его животных в формате:
    Имя_покупателя Фамилия_покупателя: Кличка_котика1, Возраст; ...; Кличка_котикаN, Возраст\n
    Имя_покупателя Фамилия_покупателя: Кличка_котика1, Возраст; ...; Кличка_котикаN, Возраст\n
    ...
    """
    ...
    for n in cats_data:
        cats = n[0] + ', ' + str(n[1])
        cats_and_owner_dict.setdefault(n[2:], []).append(cats)
    for c, o in cats_and_owner_dict.items():
        our_str += ' '.join(c) + ': ' + "; ".join(o) + '\n'
    return our_str
