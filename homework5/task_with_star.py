...
def to_roman(val):
    ...
    thousands = ["", "M", "MM", "MMM", "MMMM", "MV", "V", "VM", "VMM", "VMMM", "MX"]
    th_class = thousands[val // 1000]
    h_class = hundreds[val // 100 % 10]
    t_class = tens[val // 10 % 10]
    o_class = ones[val % 10]
    roman_str = th_class + h_class + t_class + o_class
    return roman_str
