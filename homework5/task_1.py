...
def letter_stat(our_str):
    """
    Функция считает кол-во вхождений каждой буквы в переданной строке.
    Например (Ввод --> Вывод): 'letter' --> {'l': 1, 'e': 2, 't': 2, 'r': 1}
    ...
    letters_dict = {}
    for n in our_str:
        if n in letters_dict:
            letters_dict[n] += 1
        else:
            letters_dict[n] = 1
    return letters_dict

# Погуглив, нашла еще вариант решения, но более читерский:
