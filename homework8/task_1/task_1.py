...
def treatment_sum(our_tuple):
    """
    Функция складывает 2 элемента кортежа.
    ...
    - Если в кортеже 2 элемента и их нельзя сложить, то функция обрабатывает исключение
      и возвращает строку 'Нельзя сложить эти данные'
    - Если в кортеже меньше 2 элементов, то функция обрабатывает исключение и возвращает строку 'Недостаточно данных'
