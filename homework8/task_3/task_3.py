...
def segment(point_one: tuple, point_two: tuple):
    """
    Функция возвращает сумму всех координат двух точек.
    :param point_one: координаты первой точки (x1, y1).
    :param point_two: координаты второй точки (x2, y2).
    :return:
    - Если переданы корректные данные, то функция возвращает сумму всех координат.
    - Если переданы некорректные данные, то функция возвращает текст исключения задом наперед.
    """
    try:
