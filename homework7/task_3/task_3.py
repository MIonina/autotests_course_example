...
class PublicTransport:
    """Родительский класс PublicTransport"""
    def __init__(self, brand, engine_power, year, color, max_speed):
        """
        Инициализация экземпляров класса PublicTransport.
    ...
    def info(self):
        ...
        :return: строка - информация о: марке, цвете, годе выпуска и мощности двигателя.
        """
        return (
...
class Bus(PublicTransport):
    """Класс Bus, унаследованный от класса PublicTransport"""
    def __init__(self, passenger, park, fare, brand, engine_power, year, color, max_speed):
        """
        Инициализация экземпляров класса Bus.
        :param passenger: кол-во пассажиров.
    ...
    def park(self, park):
        """
        Свойство, которое присваивает новое значение park, если оно находится в диапазоне от 1000 до 9999.
        :param park: новое значение атрибута park.
        """
...
class Tram(PublicTransport):
    """Класс Tram, унаследованный от класса PublicTransport"""
    def __init__(self, brand, engine_power, year, color, max_speed, route, path, fare):
        """
        Инициализация экземпляров класса Tram.
        :param brand: марка транспорта.
        :param engine_power: мощность двигателя.
        :param year: год выпуска.
        :param color: цвет.
